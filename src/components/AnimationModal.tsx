    ...
    >
      ...
      >
        ...
        <p className="mt-1 text-sm text-white/55">
          AR Quick Look plays one timeline. Pick a clip to keep — fewer clips
          means a much smaller file.
        </p>
        ...
        <div className="mt-5 flex items-center gap-2">
          ...
          <button
            onClick={onCancel}
            className="rounded-xl px-3 py-2.5 text-sm font-medium text-white/50 transition hover:text-white/80"
          >
            Cancel
          </button>
        </div>
